...
# returns value between 0 - 1 (never 0 or 1)
value = random.randrange()

# returns random float between 1 nad 10 are inclusive
value = random.uniform(1,10)
# returns random int between 1 nad 6 are inclusive
...
# returns list of 10 random colors, colors can repeat
colors = ['Red', 'Black', 'Green', 'Blue']
value = random.choices(colors, k=10)

#################

# create list - deck of cards
deck = list(range(1, 53))
# shuffle the cards
random.shuffle(deck)
# pick 5 random cards, cards will not repeat
